  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '50px' }}>
        <h1 style={{ fontSize: '3rem', marginBottom: '10px' }}>SUPER SMASH BROS.</h1>
        <h1 style={{ fontSize: '4rem', color: 'white', textShadow: '4px 4px var(--gc-accent-red)' }}>MELEE</h1>
        <p style={{ marginTop: '20px', fontSize: '1.2rem', color: 'var(--gc-silver)' }}>
          THE DEFINITIVE GUIDE & HISTORY
        </p>
      </div>
      ...
      <div style={{ marginTop: '40px', display: 'flex', gap: '20px' }}>
        ...
        <p style={{ alignSelf: 'center' }}>HISTORY</p>
        
        <div style={{ border: '2px solid var(--gc-indigo)', padding: '10px', borderRadius: '50%', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span style={{ color: 'var(--gc-accent-red)', fontWeight: 'bold' }}>B</span>
        </div>
        <p style={{ alignSelf: 'center' }}>TECHNIQUES</p>
      </div>
    </div>
  );
};
